               ...
               <div class="col-lg-10">
                        ...
                        <main style="height:126vh; background-color: #eef0f0 ;margin: 0px;margin-left: -14px; margin-right: -14px;padding: 20px;">  
                            <div class=" h-80 " style="width: 97%; "> 
                                ...
                                <a href="add_stdent.php"><button class="text-light text-center bg-info" style="height: 30px; border:none; border-radius: 5px;">ADD NEW STUDENT</button></a>
                                ...
                                <div class="table-responsive"> 
                                  <table class="table ">   
                                          ...
                                          <?php
                                                  foreach(mysqli_query($connect, $select) as $student){  
                                            ?>  
                                              <tr > 
                                                <td><img src="svg/imgdach.svg" alt="img"></td>  
                                                <td ><?php echo $student['name'];  ?> </td>  
                                                <td ><?php echo $student['Email'];  ?></td>
                                                <td ><?php echo $student['Phone'] ; ?></td>
                                                <td ><?php echo $student['Enroll_number'];  ?></td>
                                                <td ><?php echo $student['Date_of_Admition'];  ?></td>
                                                <td>
                                                  <div class="p-2">
                                                      <a href="update_stdent.php?id=<?php echo $student['id']?> "><img src="svg/modifier.svg" alt="img"></a> 
                                                      <a href="delet.php?id=<?php echo $student['id']?> "><img src="svg/suprimer.svg" alt="img"></a> 
                                                  </div>
                                                </td>
                                              </tr> 
